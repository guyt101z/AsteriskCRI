...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<form action="cdrflag_insert.php" method="POST">
				<input type="hidden" id="uniqueid" name="uniqueid" value="<?php echo $id; ?>">
				<div class="form-horizontal">
					<div class="form-group">
						<label for="flag_reason" class="col-sm-1 control-label">Reason</label>
						<div class="col-sm-6">
							<input type="text" id="flag_reason" name="flag_reason" class="form-control">
						</div>
						<div class="col-sm-2">
